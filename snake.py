...
# register = register.drop(register[register["snake_true_next_move"] == 'RIGHT'].index)
...
# with open(f'{model_name}_clf3.pkl', 'wb') as f:
#     pickle.dump(clfs[2], f)
# with open(f'{model_name}_clf4.pkl', 'wb') as f:
#     pickle.dump(clfs[3], f)
...
with open(f'{model_name}_clf2.pkl', 'rb') as f:
    clf2 = pickle.load(f)
with open(f'{model_name}_clf3.pkl', 'rb') as f:
    clf3 = pickle.load(f)
with open(f'{model_name}_clf4.pkl', 'rb') as f:
    clf4 = pickle.load(f)    
